...
- [ ] [DEBUG-NEEDED] - [ ] **Test with personal ROS2/ML projects** - Run scans on sample ROS2 nodes, PyTorch models, scikit-learn pipelines; verify detection of common issues (uninitialized variables, missing type hints)
